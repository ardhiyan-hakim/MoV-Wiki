    ...
    <div className="wrapper">
      ...
      <div className="content-body">
        ...
        <div className="content-body-actor">
          ...
          <p>
            Shanks, Monkey D.Luffy, Nami, Roronoa Zoro, Usopp, Coby, Sanji, Nico
            Robin, Trafalgar Law, Ben Beckman, Jinbei , Charlotte Brulee
          </p>
        </div>
        ...
        <div className="content-body-sinopsis">
          ...
          <p>
            Cerita diatur di "Pulau Musik" Elegia , di mana Uta , diva terbesar
            di dunia, mengadakan konser live pertamanya dan mengungkapkan
            dirinya kepada publik. Topi Jerami , bajak laut , Marinir , dan
            penggemar dari seluruh dunia berkumpul untuk menikmati suara Uta,
            yang telah digambarkan sebagai "dunia lain". Namun, acara dimulai
            dengan pengungkapan mengejutkan bahwa Uta adalah putri Shanks .
          </p>
        </div>
      </div>
    </div>
