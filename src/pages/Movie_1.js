    ...
    <div className="wrapper">
      ...
      <div className="content-body">
        ...
        <div className="content-body-actor">
          ...
          <p>
            Vino G. Bastian,Graciella Abigail,Mawar Eva de Jongh, Indro Warkop,
            Tora Sudiro, Rigen Rakelna, Indra Jegel, Bryan Domani, Denny
            Sumargo, Agla Artalidia, Marsha Timothy,Agoes Kencrot, Coki Pardede,
            Rifnu Wikana, Iedil Dzuhrie Alaudin, Nadila Ernesta, Makayla Rose,
            Sheila Dara Aisha, Yatti Surachman,
          </p>
        </div>
        ...
        <div className="content-body-sinopsis">
          ...
          <p>
            ...
            Dodo dimasukkan ke penjara, lebih tepatnya ke dalam sel nomor tujuh,
            yang dihuni oleh napi-napi beringas, seperti Japra (Indro Warkop),
            Jaki (Tora Sudiro), Yunus (Rigen Rakelna), Atmo (Indra Jegel), dan
            Asrul (Bryan Domani). Setelah berbagai peristiwa yang dialami Dodo
            di penjara, Dodo berhasil mendapatkan bantuan untuk menyelundupkan
            Kartika ke dalam selnya. Kedekatan Dodo dan Kartika menularkan
            kebahagiaan bagi napi dan sipir lain di dalam penjara. Mereka mulai
            ragu apakah pria penyayang seperti Dodo tega membunuh Melati.
          </p>
        </div>
      </div>
    </div>
