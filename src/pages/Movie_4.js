    ...
    <div className="wrapper">
      ...
      <div className="content-body">
        <div className="content-body-genre">
          <Card.Title>Genre :</Card.Title> <p>Adventure/Comedy/Drama/Family</p>
        </div>
        ...
        <div className="content-body-sinopsis">
          ...
          <p>
            Sebuah boneka dihidupkan oleh seorang peri, yang menugaskannya untuk
            menjalani kehidupan yang bajik untuk menjadi anak laki-laki sejati.
          </p>
        </div>
      </div>
    </div>
