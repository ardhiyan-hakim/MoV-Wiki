      ...
      <div className="wrapper">
        ...
        <div className="content-body">
          ...
          <div className="content-body-actor">
            ...
            <p>
              Acha Septriasa,Dimas Aditya,Volland Humonggio,H. Mandra,
              Beddu,Ence Bagus,Fajar Nugra,Oce Permatasari,Oce Permatasari,
              Eddies Adellia,H. Malih,Sabar Bokir,Chacha Marissa,Adam
              Jackson,Diky Otoy, Sujad Samiaji
            </p>
          </div>
          ...
          <div className="content-body-sinopsis">
            ...
            <p>
              ...
              kekasih yang saling mencintai. Namun, Mumun tewas secara
              mengenaskan dalam sebuah kecelakaan dan Juned sangat terpukul
              karenanya. Setelah jasad Mumun dikuburkan, ternyata Husein
              (Mandra) selaku penggali kubur lupa membuka tali pocong Mumun pada
              saat prosesi penguburan, sehingga ia bangkit dari kubur untuk
              meminta agar tali pocongnya dibukakan.
            </p>
          </div>
        </div>
      </div>
